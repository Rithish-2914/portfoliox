...
a.more-link {
  ...
  { id: 45, name: "Age Calculator JavaScript", description: "Calculate exact age from birth date. Shows years, months, and days with next birthday countdown.", category: "javascript", technologies: ["HTML", "CSS", "JavaScript"], features: ["Date calculation", "Years/months/days", "Birthday countdown", "Input validation"], sourceCodeUrl: "https://github.com/example/age-calculator", liveDemoUrl: "https://example.com/age-calculator" },
  { id: 46, name: "Tic Tac Toe JavaScript", description: "Classic Tic Tac Toe game with win detection. Play against another person with score tracking.", category: "games", technologies: ["HTML", "CSS", "JavaScript"], features: ["Two player mode", "Win detection", "Score tracking", "Reset game"], sourceCodeUrl: "https://github.com/example/tic-tac-toe", liveDemoUrl: "https://example.com/tic-tac-toe" },
  { id: 47, name: "JavaScript Drum Kit", description: "Interactive drum kit with keyboard controls. Play different drum sounds using your keyboard.", category: "games", technologies: ["HTML", "CSS", "JavaScript"], features: ["Keyboard controls", "Multiple sounds", "Visual feedback", "Mobile touch support"], sourceCodeUrl: "https://github.com/example/drum-kit", liveDemoUrl: "https://example.com/drum-kit" },
  { id: 48, name: "JavaScript Image Slider", description: "Responsive image slider with navigation arrows and dots. Supports auto-play and touch swipe.", category: "javascript", technologies: ["HTML", "CSS", "JavaScript"], features: ["Arrow navigation", "Dot indicators", "Auto-play", "Touch swipe"], sourceCodeUrl: "https://github.com/example/image-slider", liveDemoUrl: "https://example.com/image-slider" },
  { id: 49, name: "Random Jokes Generator JavaScript", description: "Fetches and displays random jokes from an API. Includes categories and share functionality.", category: "javascript", technologies: ["HTML", "CSS", "JavaScript"], features: ["API integration", "Multiple categories", "Share joke", "Loading state"], sourceCodeUrl: "https://github.com/example/jokes-generator", liveDemoUrl: "https://example.com/jokes-generator" },
  { id: 50, name: "Number Guessing Game JavaScript", description: "Guess the number game with hints. The game tells you if your guess is too high or too low.", category: "games", technologies: ["HTML", "CSS", "JavaScript"], features: ["Random number", "Higher/lower hints", "Attempt counter", "Play again"], sourceCodeUrl: "https://github.com/example/number-guess", liveDemoUrl: "https://example.com/number-guess" },
  { id: 51, name: "Speech Recognition JavaScript", description: "Voice command recognition using Web Speech API. Execute actions based on spoken commands.", category: "javascript", technologies: ["HTML", "CSS", "JavaScript"], features: ["Voice commands", "Command list", "Visual feedback", "Browser support check"], sourceCodeUrl: "https://github.com/example/speech-recognition", liveDemoUrl: "https://example.com/speech-recognition" }
];
